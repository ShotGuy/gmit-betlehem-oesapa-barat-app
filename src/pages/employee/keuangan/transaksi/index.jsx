...
export default function EmployeeRealisasiKeuanganPage() {
    ...
    const canManage = authData?.pegawai?.canManageKeuangan;
    ...
    // Check access if needed, but Page usually handles it. 
    // We can add a simple check here or rely on the fact that the menu is hidden
    ...
    return (
        <div className="space-y-6 p-4">
            <PageHeader
                ...
                description="Kelola dan pantau realisasi vs target anggaran (Staff View)"
                title="Transaksi Keuangan"
            />

            <PageTitle title={"Transaksi Keuangan"} />
                        ...
                        {canManage && (
                            <div className="flex items-end gap-2">
                                <Button
                                    ...
                                    onClick={() => router.push("/employee/keuangan/transaksi/create")}
                                >
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p
                                        className={`text-2xl font-bold ${parseFloat(
                                    ...
                                    <table className="w-full border-collapse border border-gray-300 dark:border-gray-600">
                                        <thead>
                                            <tr className="bg-gray-100 dark:bg-gray-800">
                                                ...
                                                {/* Employee can't drill down to detail settings usually, but allows read */}
                                                {/* Removing actions for summary view to simplify */}
                                            </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                filteredItemSummary.map((item) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <td className="border border-gray-300 dark:border-gray-600 px-4 py-3 text-right">
                                                                <span
                                                                    className={`text-sm font-semibold ${parseFloat(item.varianceAmount) >= 0
                                                            ...
                                                            {canManage && (
                                                                <div className="flex justify-center gap-2">
                                                                    <Button
                                                                        ...
                                                                        onClick={() =>
                                                                            router.push(
                                                                                `/employee/keuangan/transaksi/edit/${realisasi.id}`
                                                                            )
                                                                        }
                                                                    >
                                                                        <Edit className="h-4 w-4" />
                                                                    </Button>
                                                                    {/* Hide Delete for Employee, make it read-only safe or highly restricted */}
                                                                </div>
                                                            )}
                                                        </td>
                                                    </tr>
