...
export default function JadwalIbadahPage() {
    ...
    const actions = [
        {
            icon: Eye,
            label: "Detail",
            onClick: (item) => router.push(`/employee/jadwal-ibadah/${item.id}`), // Changed route
            variant: "outline",
        },
        {
            icon: Edit,
            label: "Edit",
            onClick: (item) => router.push(`/employee/jadwal-ibadah/${item.id}/edit`), // Changed route
            variant: "outline",
        },
        {
            icon: Trash2,
    ...
    return (
        <div className="space-y-6 p-4">
            ...
            <PageHeader
                breadcrumb={[
                    { label: "Dashboard", href: "/employee/dashboard" }, // Changed route
                    { label: "Jadwal Ibadah" },
                ]}
                description="Kelola jadwal ibadah yang akan dilaksanakan di gereja atau secara online"
                title="Daftar Jadwal Ibadah"
                onAdd={() => router.push("/employee/jadwal-ibadah/create")} // Changed route
            />
