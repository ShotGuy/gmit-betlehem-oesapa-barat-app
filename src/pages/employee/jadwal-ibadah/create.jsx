...
export default function CreateJadwalIbadah() {
    ...
    const createMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            router.push("/employee/jadwal-ibadah"); // Route to Employee list
        },
        onError: (error) => {
            showToast({
                title: "Gagal",
    ...
    return (
        <>
            <PageTitle
                description="Buat jadwal ibadah baru"
                title="Tambah Jadwal Ibadah"
            />
            <div className="space-y-6 p-4">
                <PageHeader
                    subtitle="Buat jadwal ibadah baru"
                    title="Tambah Jadwal Ibadah"
                    onBack={() => router.push("/employee/jadwal-ibadah")} // Route to Employee list
                />
