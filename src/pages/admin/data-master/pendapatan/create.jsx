...
export default function CreatePendapatanPage() {
  ...
  const onSubmit = async (data) => {
    const res = await masterService.createPendapatan(data);
    ...
    if (res.success) {
      ...
      showToast({
        ...
        description: res.message || "Terjadi kesalahan saat menambahkan data",
        color: "error",
      });
    }
  };
