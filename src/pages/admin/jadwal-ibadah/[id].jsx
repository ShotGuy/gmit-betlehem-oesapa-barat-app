...
export default function DetailJadwalIbadahAdmin() {
    ...
    return (
        <>
            ...
            <div className="space-y-6 p-4">
                <PageHeader subtitle="Informasi lengkap jadwal" title="Detail Jadwal Ibadah" onBack={() => router.push("/admin/jadwal-ibadah")} />
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
                    ...
                    <div className="flex gap-2">
                        <Button variant="outline" onClick={() => router.push(`/admin/jadwal-ibadah/${id}/edit`)}>
