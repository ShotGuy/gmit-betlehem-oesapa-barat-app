...
export default function EditJadwalIbadahAdmin() {
    ...
    const { data: jadwalData, isLoading: isLoadingJadwal, error: jadwalError } = useQuery({
    ...
    const updateMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            router.push(`/admin/jadwal-ibadah/${id}`);
        },
        onError: (error) => {
    ...
    return (
        <>
            ...
            <div className="space-y-6 p-4">
                <PageHeader subtitle="Perbarui informasi jadwal" title="Edit Jadwal Ibadah" onBack={() => router.push("/admin/jadwal-ibadah")} />
                <Card className="p-6">
                    <FormProvider {...form}>
